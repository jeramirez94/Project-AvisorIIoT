...
/****** Object:  Table [AswSch].[AswBitBitBitacoraParo]    Script Date: 11/11/2022 04:04:53 p. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [AswSch].[AswBitBitBitacoraParo](
 ...
 CONSTRAINT [PK_AswBitBitBitacoraParo] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
...
ALTER TABLE [AswSch].[AswBitBitBitacoraParo] ADD  DEFAULT ((0)) FOR [MicroParoSN]
GO

ALTER TABLE [AswSch].[AswBitBitBitacoraParo] ADD  DEFAULT ((0)) FOR [BajaLogica]
GO

ALTER TABLE [AswSch].[AswBitBitBitacoraParo] ADD  DEFAULT ((0)) FOR [ClaEventoCierre]
GO
