USE [ASW]
GO
/****** Object:  StoredProcedure [AswSch].[ASW_CU304_Pag2_CalcEgeSemanal_IU]    Script Date: 15/11/2022 02:32:15 p. m. ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROC  [AswSch].[ASW_CU304_Pag2_CalcEgeSemanal_IU] 
	 @PnClaUbicacion INT
...
DECLARE @nId INT
	...
	DELETE FROM [AswSch].[AswEstEGESemanal]
	...
	FROM [AswSch].[AswEstEGESemanal]

	INSERT INTO [AswSch].[AswEstEGESemanal]
			   ( Id
			   ,[ClaUbicacion]
			   ,[ClaveUbicacion]
			   ,[Anio]
